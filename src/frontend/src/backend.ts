...
import type { Member as _Member, MemberId as _MemberId, MemberRole as _MemberRole, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createNewsItem(arg0: string, arg1: Time, arg2: string, arg3: string): Promise<NewsId> {
        if (this.processError) {
            try {
                const result = await this.actor.createNewsItem(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getForumStatistics(): Promise<{
        other: bigint;
        entrepreneurs: bigint;
        civilSociety: bigint;
        totalMembers: bigint;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getForumStatistics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerMember(arg0: string, arg1: string, arg2: MemberRole, arg3: string, arg4: string, arg5: string): Promise<MemberId> {
        if (this.processError) {
            try {
                const result = await this.actor.registerMember(arg0, arg1, to_candid_MemberRole_n11(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContactMessage(arg0: string, arg1: string, arg2: string, arg3: string): Promise<ContactMessageId> {
        if (this.processError) {
            try {
...
function from_candid_MemberRole_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MemberRole): MemberRole {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        name: value.name,
        role: from_candid_MemberRole_n6(_uploadFile, _downloadFile, value.role),
        email: value.email,
        state: value.state,
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "policy_maker" in value ? MemberRole.policy_maker : "entrepreneur" in value ? MemberRole.entrepreneur : "other" in value ? MemberRole.other : "civil_society" in value ? MemberRole.civil_society : "youth" in value ? MemberRole.youth : value;
}
...
function to_candid_MemberRole_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MemberRole): _MemberRole {
    return to_candid_variant_n12(_uploadFile, _downloadFile, value);
}
function to_candid_UserRole_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserRole): _UserRole {
    return to_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function to_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MemberRole): {
    policy_maker: null;
} | {
    entrepreneur: null;
} | {
    ...
    return value == MemberRole.policy_maker ? {
        policy_maker: null
    } : value == MemberRole.entrepreneur ? {
        entrepreneur: null
    } : value == MemberRole.other ? {
        other: null
    } : value == MemberRole.civil_society ? {
        civil_society: null
    } : value == MemberRole.youth ? {
        youth: null
    } : value;
}
